...
//******************************************************************************
  ...
  var __sp = S.prototype = {
    ...
    //#Added a New Function called wrap to wrap th Html element and their attributes.
    wrap: function (tagName, tagAttrs) {
      var el = (tagName === undefined) ? 'p' : tagName, elAttr = '', wrapped = '';
      if(typeof tagAttrs == 'object') for(prop in tagAttrs) elAttr += ' ' + prop + '="' + tagAttrs[prop] + '"';
      return wrapped.concat('<', el, elAttr, '>', this, '</', el, '>');
    }
  }
