  ...
  var __sp = S.prototype = {
    ...
    toCSV: function(options) {
      ...
      if (typeof options === 'object') {
        delim = options.delimiter === undefined ? delim : options.delimiter;
        delim = options.separator === undefined ? delim : options.separator;
        qualifier = (options.qualifier === undefined ? qualifier : options.qualifier);
        escape = (options.escape === undefined ? escape : options.escape);
